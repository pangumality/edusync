  ...
  if (isMobile) {
    return (
      <div className="min-h-screen bg-surface-50 flex flex-col relative overflow-hidden">
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-50 flex">
            ...
            <div className="relative bg-white w-4/5 max-w-sm h-full shadow-2xl flex flex-col animate-slide-in">
              <div className="p-4 bg-gradient-to-r from-brand-800 via-brand-700 to-brand-600 text-white flex justify-between items-center relative overflow-hidden">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-brand-800 via-brand-700 to-brand-600 text-white h-16 flex items-center justify-between px-4 sm:px-8 shadow-lg z-50 relative overflow-hidden">
    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className={clsx(
            "bg-gradient-to-b from-brand-900 via-brand-800 to-brand-600 text-white border-r border-white/10 overflow-y-auto flex-shrink-0 pb-10 transition-all duration-300 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.35)] z-10 relative",
